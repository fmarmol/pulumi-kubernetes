...
export class RoleBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:rbac.authorization.k8s.io/v1alpha1:RoleBinding';
     ...
     */
    public readonly roleRef!: pulumi.Output<outputs.rbac.v1alpha1.RoleRef>;
    /**
     * Subjects holds references to the objects the role applies to.
     */
    public readonly subjects!: pulumi.Output<outputs.rbac.v1alpha1.Subject[]>;
