...
export class ClusterRoleBindingList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.rbac.v1alpha1.ClusterRoleBinding[]>;
    /**
