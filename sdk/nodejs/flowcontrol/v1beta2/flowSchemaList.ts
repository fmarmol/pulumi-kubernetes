...
export class FlowSchemaList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:FlowSchemaList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.flowcontrol.v1beta2.FlowSchema[]>;
    /**
