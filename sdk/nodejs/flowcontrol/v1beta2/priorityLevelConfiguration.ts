...
export class PriorityLevelConfiguration extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfiguration';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.flowcontrol.v1beta2.PriorityLevelConfigurationSpec>;
    /**
     * `status` is the current status of a "request-priority". More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public /*out*/ readonly status!: pulumi.Output<outputs.flowcontrol.v1beta2.PriorityLevelConfigurationStatus>;
    ...
    constructor(name: string, args?: PriorityLevelConfigurationArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            inputs["apiVersion"] = "flowcontrol.apiserver.k8s.io/v1beta2";
