...
export class PriorityLevelConfigurationList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfigurationList';
     ...
     */
    public readonly items!: pulumi.Output<outputs.flowcontrol.v1beta2.PriorityLevelConfiguration[]>;
    /**
