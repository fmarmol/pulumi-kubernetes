...
func NewPriorityLevelConfigurationList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfigurationList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPriorityLevelConfigurationList(ctx *pulumi.Context,
	...
	var resource PriorityLevelConfigurationList
	err := ctx.ReadResource("kubernetes:flowcontrol.apiserver.k8s.io/v1beta2:PriorityLevelConfigurationList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
