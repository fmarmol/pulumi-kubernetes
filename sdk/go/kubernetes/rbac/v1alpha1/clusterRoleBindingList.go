...
func NewClusterRoleBindingList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClusterRoleBindingList(ctx *pulumi.Context,
	...
	var resource ClusterRoleBindingList
	err := ctx.ReadResource("kubernetes:rbac.authorization.k8s.io/v1alpha1:ClusterRoleBindingList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o ClusterRoleBindingListOutput) ToClusterRoleBindingListPtrOutputWithContext(ctx context.Context) ClusterRoleBindingListPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ClusterRoleBindingList) *ClusterRoleBindingList {
		return &v
...
func (o ClusterRoleBindingListPtrOutput) Elem() ClusterRoleBindingListOutput {
